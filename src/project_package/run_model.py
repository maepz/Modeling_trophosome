...
def run_generation_of_host_pop_v5(freelivingG, n_worms, infection_sym_count,host_pop_gen,escape_rate,
                     mutation_rate, pop_size_thr, 
                     t=0,nthreads=1):
    
    '''this is the same as run_generation_of_host_pop_v3 but uses tskit instead of the Wright-Fisher to get Graph_list_init_intrahost,Graph_list_hostassociated,Graph_list_escapees. But in this version the ploidy is set properly (ploidy=1), and there is a demographic parameter with a growth rate'''
...
def run_generation_of_host_pop_v2(freelivingG, n_worms, infection_sym_count,host_pop_gen,escape_rate,
    ...
    '''This is the same as run_generation_of_host_pop but uses tskit instead of the Wright-Fisher to get Graph_list_init_intrahost,Graph_list_hostassociated,Graph_list_escapees. This version is not parallelized'''
