...
from project_package.run_model import run_generation_of_host_pop_v3
...
with warnings.catch_warnings():
    ...
    for trial in range(n_trials):
        ...
        for host_pop_gen in range(1,tot_host_pop_gen+1):
            ...
            merged_Graph_hostassociated, merged_Graph_freeliving=run_generation_of_host_pop_v3(myfreelivingG, n_worms, infection_sym_count,host_pop_gen,escape_rate, mutation_rate, pop_size_thr=pop_size_thr,t=0,nthreads=cpus)
